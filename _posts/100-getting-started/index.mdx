...
<div className="mt-8 grid gap-6 md:grid-cols-2">
    ...
    <Card title="Example Project" icon="github" link={{url: 'https://github.com/contentlayerdev/next-contentlayer-example', label: 'See example'}}>
        You can find a working version of this tutorial in [this state](https://github.com/contentlayerdev/next-contentlayer-example/tree/bca4b7884f5cad8963e631a2f24a19200c106495)
